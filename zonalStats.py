# -*- coding: utf-8 -*-
"""
Created on Sun Oct 18 10:00:58 2015
...
def zonal_stats(feat, input_zone_polygon, input_value_raster):
    ...
    stats = [numpy.average(zoneraster), numpy.mean(zoneraster),
             numpy.median(zoneraster), numpy.std(zoneraster),
             numpy.std(zoneraster), numpy.var(zoneraster), zoneraster.count]
